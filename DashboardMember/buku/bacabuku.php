...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="../asset/icon/logo-tpm.png">
...
<body>
    <center>
        ...
        <?php foreach ($query as $item) : ?>
            ...
            <embed type="application/pdf" src="../../assets/isi-buku/<?php echo $item['isi_buku']; ?>#toolbar=0" width="100%" height="700"></embed>
        <?php
        endforeach;
        ?>
    </center>
